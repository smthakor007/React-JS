...
export default function Firebaseedb() {
    ...
    useEffect(() => {
        const usersRef = ref(database, 'users/Sunil');
    ...
    function sendData() {
        if (editId) {
            ...
            const userRef = ref(database, `users/Sunil/${editId}`);
            update(userRef, {
    ...
    function deleteUser(id) {
        const userRef = ref(database, `users/Sunil/${id}`);
        remove(userRef)
            .then(() => {
